...
return $.extend(This, {  /**@lends MiniQuery.Url */
    ...
    */
    addQueryString: function (url, key, value) {
        ...
        var qs = This.getQueryString(url) || {}; //先取出原来的
        ...
        return This.setQueryString(url, obj);
    ...
    */
    randomQueryString: function (url, len) {
        ...
        return This.addQueryString(url, key, '');
    },
...
})(MiniQuery, MiniQuery.Url, MiniQuery.Mapper, MiniQuery.Event);
