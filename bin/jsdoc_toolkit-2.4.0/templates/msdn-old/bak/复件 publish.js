...
function publish(symbolSet)
{
    ...
    IO.copyFile(publish.conf.templatesDir + "/" + publish.conf.jsDir + "jquery-1.9.1.min.js", publish.conf.outDir + "/" + publish.conf.jsDir);
    IO.copyFile(publish.conf.templatesDir + "/" + publish.conf.jsDir + "jquery.observehashchange.js", publish.conf.outDir + "/" + publish.conf.jsDir);
    
    
    
    
	
	IO.copyFile(publish.conf.templatesDir + "/" + publish.conf.imgDir + "static.bmp", publish.conf.outDir + "/" + publish.conf.imgDir);
	IO.copyFile(publish.conf.templatesDir + "/" + publish.conf.imgDir + "method.bmp", publish.conf.outDir + "/" + publish.conf.imgDir);
	IO.copyFile(publish.conf.templatesDir + "/" + publish.conf.imgDir + "collapse-.bmp", publish.conf.outDir + "/" + publish.conf.imgDir);
	IO.copyFile(publish.conf.templatesDir + "/" + publish.conf.imgDir + "collapse+.bmp", publish.conf.outDir + "/" + publish.conf.imgDir);
	IO.copyFile(publish.conf.templatesDir + "/" + publish.conf.imgDir + "bar.bmp", publish.conf.outDir + "/" + publish.conf.imgDir);
	IO.copyFile(publish.conf.templatesDir + "/" + publish.conf.imgDir + "property.bmp", publish.conf.outDir + "/" + publish.conf.imgDir);
	IO.copyFile(publish.conf.templatesDir + "/" + publish.conf.imgDir + "field.bmp", publish.conf.outDir + "/" + publish.conf.imgDir);
