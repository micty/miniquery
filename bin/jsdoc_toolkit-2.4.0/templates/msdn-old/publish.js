...
function publish(symbolSet)
{
    ...
    try 
    {
        var classTemplate = new JSDOC.JsPlate(publish.conf.templatesDir + "json.html");
    } 
    catch (e) 
    {
    ...
    try 
    {
        var classesindexTemplate = new JSDOC.JsPlate(publish.conf.templatesDir + "allclasses.html");
    } 
    catch (e) 
    {
        print(e.message);
    ...
    try 
    {
        var fileindexTemplate = new JSDOC.JsPlate(publish.conf.templatesDir + "allfiles.html");
    } 
    catch (e) 
    {
        print(e.message);
